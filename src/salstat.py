...
from dialogs import auiNotebookWrap
...
class Grids(auiNotebookWrap):
    def __init__(self, parent, id= wx.ID_ANY, *args, **params):
        auiNotebookWrap.__init__(self, parent, id, *args, **params)
	...
	grid=  SimpleGrid( self, size= (500,20))
        grid.hasSaved= True
